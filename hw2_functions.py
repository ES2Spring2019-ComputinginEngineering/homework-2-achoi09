...
#*****************************************
# YOUR NAME: Allison Choi
# NUMBER OF HOURS TO COMPLETE: 7 (please track how long this homework takes you to complete).
# YOUR COLLABORATION STATEMENT(s) (refer to syllabus): Yassi Khorsandian
#
#*****************************************
...
def areaofatriangle(m1, b1, m2, b2, m3, b3):
    ...
    if (m1-m2)==0 or (m3-m1)==0 or (m3-m2)==0:
    ...
    if (x1==x2==x3) and (y1==y2==y3):
        print("Error: the lines intersect at the same point")

    d1 = distancebetweenpoints(x1, y1, x2, y2)
    d2 = distancebetweenpoints(x2, y2, x3, y3)
    d3 = distancebetweenpoints(x1, y1, x3, y3)
    area = heronsformula(d1, d2, d3) #replace this with your calculation for area
    return area
